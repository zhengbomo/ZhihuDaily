...
namespace Shagu.Controls
{
    public sealed class SwipeableSplitView : SplitView
    {
        ...
        public SwipeableSplitView()
        {
            ...
            PaneClosed += SwipeableSplitView_PaneClosed;
        }

        private void SwipeableSplitView_PaneClosed(SplitView sender, object args)
        {
            IsSwipeablePaneOpen = sender.IsPaneOpen;
        }
        ...
        internal Grid PaneRoot
        {
            ...
            set
            {
                if (_paneRoot != null && IsSwipeabled)
                {
        ...
        public static readonly DependencyProperty PanAreaThresholdProperty =
            DependencyProperty.Register("PanAreaThreshold", typeof(double), typeof(SwipeableSplitView), new PropertyMetadata(18d));

        public static readonly DependencyProperty IsSwipeabledProperty = DependencyProperty.Register(
            "IsSwipeabled", typeof (bool), typeof (SwipeableSplitView), new PropertyMetadata(true));

        public bool IsSwipeabled
        {
            get { return (bool) GetValue(IsSwipeabledProperty); }
            set { SetValue(IsSwipeabledProperty, value); }
        }
