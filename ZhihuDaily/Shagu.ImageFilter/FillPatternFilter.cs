...
namespace Shagu.ImageFilter
{
    public class FillPatternFilter : IImageFilter
    {
        ...
        public FillPatternFilter(WriteableBitmap writeableBitmap)
        {
            this.pattern = Image.LoadImage(writeableBitmap);
        }

        public FillPatternFilter(WriteableBitmap writeableBitmap, int Mixture)
        {
            this.pattern = Image.LoadImage(writeableBitmap);
