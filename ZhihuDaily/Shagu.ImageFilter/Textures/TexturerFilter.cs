        ...
        public Image process(Image imageIn) 
        {
            ...
            for ( int y = 0; y < heightToProcess; y++ )
            {
                for ( int x = 0; x < widthToProcess; x++ )
                {
                    ...
                    r = (byte) System.Math.Min( 255.0f, ( preserveLevel * r) + ( filterLevel * r) * t );
                    g = (byte) System.Math.Min( 255.0f, ( preserveLevel * g) + ( filterLevel * g) * t );
                    b = (byte) System.Math.Min( 255.0f, ( preserveLevel * b) + ( filterLevel * b) * t );
