    ...
    public class ColorToneFilter : IImageFilter
    {
        ...
        */
        static double[] RGBtoHLS (int rgb, double H, double L, double S)
        {
            ...
            int n_cmax = System.Math.Max(colorR, System.Math.Max(colorG, colorB));
            int n_cmin = System.Math.Min(colorR, System.Math.Min(colorG, colorB));
        ...
        */
	    ...
	    public ColorToneFilter(int tone, int saturation)
        {
            ...
            for (int i=0 ; i < 256 ; i++)
            {
                ...
                ll = result[1];
                s = result[2];
                ll = ll * (1 + (128 - System.Math.Abs(saturation - 128)) / 128.0 / 9.0);
